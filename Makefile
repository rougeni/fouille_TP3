...
rand:
	gcc -O3 -lm -Wall -Werror -g -c src/rand.c -o bin/rand.o

document:
	gcc -O3 -lm -std=gnu99 -Wall -Werror -g -c src/document.c -o bin/document.o

modele:
	gcc -O3 -lm -std=gnu99 -Wall -Werror -g -c src/modele.c -o bin/modele.o
...
test_doc: document
	gcc -O3 -lm -std=gnu99 -Wall -Werror -g src/test_doc.c bin/document.o -o bin/test_doc

all: main

test: document parsing
	gcc -O3 -lm -std=gnu99 -Wall -Werror -g src/test.c bin/parsing.o bin/document.o -o bin/test
